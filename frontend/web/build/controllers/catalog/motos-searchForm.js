...
var productType = $(this).find('a').data('producttype');
$("input[name='ProductSearchForm[type]']").val(productType);
        updateMakersList(productType);
        getCount();
