...
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/jquery.maskedinput/1.4.1/jquery.maskedinput.js');
$this->registerJsFile('/js/avto-v-credit.js');
$this->registerJs("require(['controllers/tools/calculator']);", \yii\web\View::POS_END);
$this->registerCssFile('/css/avto-v-kredit.css');
