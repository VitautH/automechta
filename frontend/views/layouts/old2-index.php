...
if ((($controller->id === $default_controller) && ($controller->action->id === $controller->defaultAction))
   // || ($controller->action->id === 'categorycompany') || ($controller->action->id == 'search')
    //|| ($controller->action->id == 'newcategory') || ($controller->action->id == 'motos')
    //|| ($controller->action->id == 'newmaker') || ($controller->action->id == 'newmodelauto') || ($controller->action->id == 'boat')
    || ($controller->action->id == 'contact') || ($controller->id == 'account') || (Yii::$app->request->url == '/obmen-avto')
    || (Yii::$app->request->url == '/srochnyj-vykup')
    || (Yii::$app->request->url == '/prijom-avto-na-komissiju')
    || (Yii::$app->request->url == '/avto-v-kredit')
    || (Yii::$app->request->url == '/oformlenie-schet-spravki')
    || (Yii::$app->request->url == '/create-ads')
) {
    ?>
            ...
            <div class="row hidden-xs hidden-sm">
                <div class="col-md-2 col-xs-2 col-sm-6 ">
                    <div class="b-nav__logo">
                        <a href="/">
                            <img width="220px" src="/uploads/3/b/4/220x75/logo.png"/>
                        </a>
                ...
                <div class="col-md-3 hidden-xs hidden-sm">
                    <a href="<?= Yii::$app->user->isGuest == true ? '#' : '/create-ads'; ?>"
                       class="<?= Yii::$app->user->isGuest == true ? 'show-modal-login' : ''; ?> btn m-btn m-btn-dark header-create-button">
