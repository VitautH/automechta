            ...
            <div class="row">
                ...
                <div class="js-product-list col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <div id="w0" class="b-items__cars">
                        ...
                        foreach ($products as $i => $product):
                            ...
                            <div class="b-items__cars-one" data-key="<?= $product->id ?>">
                                <div class="visible-xs  b-items__cars-one-info-header s-lineDownLeft">
                                    <h2>
                                        <a href="<?= Url::UrlShowProductBoat($product->id) ?>"><?= Html::encode($product->make).' '.$product->year.' г.в.'; ?></a>
                                ...
                                <div class="photo_mobile_block  visible-xs col-xs-4">
                                    <a href="<?= Url::UrlShowProductBoat($product->id) ?>" class="b-items__cars-one-img">
                                        <img src="<?= $product->title_image ?>" alt="<?= Html::encode($product->make).' ('.$product->year.')'; ?>"
                        ...
                        ?>
                        <div class="pagination_mobile visible-xs visible-sm col-xs-12" data-wow-delay="0.5s">
