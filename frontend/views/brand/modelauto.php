...
<div class="breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><span class="ml-lg-2"><a href="<?
                    echo Url::UrlCategoryBrand($type, $make_name); ?>"><?php echo $make_name; ?><i class="fas fa-chevron-right ml-1 ml-lg-2"></i></a></span></li>
            <li><span class="no-link ml-lg-2"><?php echo $_params_['model_name'];?></span></li>
    ...
    <div class="container">
        <div class="row">
            <div class="title-block col-12">
                <h1>Продажа <?= $make_name . ' ' . $_params_['model_name'] ?> в Беларуси в кредит    <span class="count-ads"><?= Yii::t('app', 'Your search returned {n,plural,=0{# result} =1{# result} one{# results} other{# results}} ', ['n' => $_params_['count']]) ?>
</span></h1>
            </div>
        </div>
    </div>
