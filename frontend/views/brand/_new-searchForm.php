                ...
                <ul role="tablist" class="tabslist">
                    <li class="tabsitem">
                        <a role="tab" class="product-type" aria-controls="bike" data-productType="<?php echo ProductType::MOTO;?>" href="#moto" title="Мотоциклы" tabindex="0" aria-selected="true">
                            ...
                            <span class="name">Мотоцикл</span>
                        </a>
                    </li>
                    <li class="tabsitem">
                        <a role="tab" class="product-type" aria-controls="scooter" data-productType="<?php echo ProductType::SCOOTER;?>" href="#scooter" title="Квадроциклы" tabindex="0" aria-selected="false">
                            <span class="category-img kv-cycle"></span>
                            <span class="name">Скутер</span>
                        </a>
                    </li>
                    <li class="tabsitem">
                        <a role="tab" class="product-type" aria-controls="atv" data-productType="<?php echo ProductType::ATV;?>" href="#atv" title="Скутеры" tabindex="0" aria-selected="false">
                            <span class="category-img scooter"></span>
                            <span class="name">Квадроцикл</span>
                        </a>
                    </li>
                </ul>
            </div>
...
<input type="hidden" name="ProductSearchForm[type]" value="<?php echo ProductType::MOTO;?>">
    ...
    <div class="search-submit text-center row justify-content-center">
        <button class="custom-button" type="submit"  id="search-motos"><i class="fa fa-search mr-2"></i>Найти</button>
    </div>
<?php ActiveForm::end(); ?>
</div>
