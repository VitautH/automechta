...
<div class="breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><span class="no-link ml-lg-2">Каталог <?php echo $typeName; ?></span></li>
        </ul>
    </div>
</div>
<main>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="brands brands-catalog">
                        <?php
                        $modelAutoHighPriority = ProductMake::getMakesListHighPrirority($type, true);
                        ...
                        ?>
                        <?php
                        $modelAutoLowPriority = ProductMake::getMakesListLowPrirority($type, true);
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-3 mb-4 pr-lg-5">
                            <div id="filter">
                                ...
                                <?php
                                if ($type == ProductType::CARS) {
                                    echo $this->render('_newSearchFormAuto', $_params_);
                                } else {
                                    echo $this->render('_newSearchFormOther', $_params_);
