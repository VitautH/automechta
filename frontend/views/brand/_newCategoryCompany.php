...
$this->title = 'Каталог автомобилей  компании с фото и ценой в Беларуси в кредит';
...
<div class="breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><span class="no-link ml-lg-2">Автомобили компании</span></li>
        </ul>
    </div>
</div>
<main>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="brands brands-catalog">
                        <?php
                        $modelAutoHighPriority = ProductMake::getMakesListHighPrirority(2, true);
                        sort($modelAutoHighPriority);
                        foreach ($modelAutoHighPriority as $maker) {
                            ?>
                        ...
                        unset($modelAutoHighPriority);
                        ?>
                        <?php
                        $modelAutoLowPriority = ProductMake::getMakesListLowPrirority(2, true);
                        sort($modelAutoLowPriority);
                        foreach ($modelAutoLowPriority as $maker) {
                            ?>
                            <div class="brand-item">
                                <a href='<?= Url::UrlCategoryBrand(Url::CARS, $maker['name']) ?>'>
                                    <?php if ($maker['url_logo'] != null):
        ...
        <div class="container">
            <ul class="nav nav-tabs row" id="myTab" role="tablist">
                <li class="nav-item col-lg-2 p-0">
                    <a class="nav-link active" href="#">Авто компании</a>
                </li>
                <li class="nav-item col-lg-2 p-0">
                ...
                <div class="row">
                                    ...
                                    <div class="catalog-item b-items__cars-one" data-key="<?= $product->id ?>">
                                        <div class="catalog-item-img">
                                            <a href="<?= Url::UrlShowProduct($product->id) ?>">
                                                <img src="<?= $product->full_title_image ?>"
                                        ...
                                        <div class="favorite">
                                            ...
                                            <?php
                                                ...
                                                if (Bookmarks::find()->where(['user_id'=>Yii::$app->user->id])->andWhere(['product_id'=>$product->id])->exists()):
                                                    ?>
                                                    <a href="#"  title="Удалить из закладок" data-product="<?= $product->id;?>" id="delete-bookmarks" class="bookmarks star in-favorite">
                                                        <i class="far fa-star"></i>
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                    <a href="#" data-product="<?= $product->id;?>" id="add-bookmarks" class="bookmarks star add-to-favorite">
                                                        <i class="far fa-star"></i>
                                                        <span class="add-tooltip">В избранное</span>
                                                    </a>
                                                <?php
                    ...
                    <div class="col-12 col-lg-3 mb-4 pr-lg-5">
                        <div id="filter">
                            ...
                            <?php
                                echo $this->render('_newSearchFormAuto', $_params_);
                            ?>
                        </div>
                        <div class="online-request hidden-mobile">
                            <h2>ONLINE-заявка на кредит</h2>
