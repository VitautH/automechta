...
<div class="catalog">
    ...
    <div id="search_block_mobile">
        ...
        <?= $this->render('_searchMobileFormCompany', $_params_) ?>
        </div>
    </div>
</div>
    <!--b-infoBar-->
        ...
        <div class="container" style="width:97%;">
            ...
            <div class="row">
                    ...
                    <div id="w0" class="b-items__cars">
                                ...
                                <div class="b-items__cars-one-info">
                                    ...
                                    <div class="row s-noRightMargin">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <span><?= City::getCityName($product->city_id); ?><?//= User::getRegions()[$product->region];
                                                ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="visible-xs visible-sm col-xs-12" data-wow-delay="0.5s">
                            <?php if ($currentPage != 1): ?>
                                <a class="btn m-btn m-btn-dark" href="<?= Url::current(['page' => $currentPage - 1]) ?>"
                ...
                <div class="col-lg-3 col-sm-4 col-xs-12">
                    ...
                    <h2 class="s-title  visible-md visible-lg" data-wow-delay="0.5s">Поиск авто</h2>
                    <div id="search_block_desktop" class="visible-md visible-lg">
                        <div class="search_block">
                    <?= $this->render('_searchFormCompany', $_params_) ?>
                        </div>
                    </div>
                    <h2 class="s-title  visible-md visible-lg" data-wow-delay="0.5s">Услуги компании</h2>
