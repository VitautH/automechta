...
$disabledMakes = false;
if ((empty($_params_['ProductSearchForm']['make']) || ($_params_['ProductSearchForm']['make'] == null))) {
    $disabledMakes = true;
}
    ...
    <div class="form-block">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-12 col-9">
                ...
                <div class="<?php if ($disabledMakes){echo 'disabled';}?> select-search-block">
                    <?= Html::dropDownList(
                        'ProductSearchForm[model]',
                        $searchForm->model,
                        ProductMake::getModelsList($searchForm->make),
                        ['class' => 'm-select', 'disabled'=>$disabledMakes,'prompt' => 'Модель']) ?>
                    <i class="fas fa-chevron-down"></i>
                </div>
            </div>
            ...
            <div class="col-lg-6 pl-lg-0 col-4 pl-0">
