       ...
       // var_dump(Yii::$app->cache->exists('main_page'));
        ...
        <section class="b-makers" id="b-makers">
            <div class="container">
                <div class="row col-lg-12">
                    ...
                    <div class="b-makers__list b-makers__list__main" id="b-makers__list__main" style="height: auto!important;">
                        <?php
                ...
                <div class="top col-md-12 col-xs-12 col-sm-12">
                    <div class="container">
                        <h2 class="col-md-10 col-sm-10 col-xs-9 col-sm-10">
                            ...
                            <a href="/cars/company" class="show-all visible-md visible-lg visible-xl"><?= Yii::t('app', 'Show all') ?> </a>
        ...
        <section class="b-featured b-featured-latest">
            <div class="container">
                <div class="top col-md-12">
                    <div class="container">
                        <h2 class="col-md-10 col-xs-9 col-sm-10">
                            ...
                            <a href="/cars" class="show-all visible-md visible-lg visible-xl"><?= Yii::t('app', 'Show all') ?></a>
                        </h2>
                ...
                <div id="carousel-small-2" class="carousel-product  owl-carousel js-featured-vehicles-caruosel-2" data-items="4"
                     data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4"
