    ...
    <div id="carousel" class="slide carousel carousel-fade">
        <div class="carousel-inner">
            ...
            <div class="item <?= $key === 0 ? 'active' : '' ?>">
                <img style="max-height: 900px" src="<?= $slider->getTitleImageUrl(1920, 800) ?>" alt="sliderImg" />
                <div class="container">
                    <div class="carousel-caption b-slider__info b-slider__info-text-position-<?= $slider->text_position ?>">
                        ...
                        <a class="btn m-btn" href="<?= $slider->link ?>"><?= $slider->i18n()->button_text ?><span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
...
<section class="b-featured">
    <div class="container">
        ...
        <div id="carousel-small" class="owl-carousel js-featured-vehicles-caruosel" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="4" data-items-tablet="3" data-items-tablet-small="2">
            <?php foreach($highPriorityProducts as $highPriorityProduct): ?>
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                        <a href="<?= $highPriorityProduct->getUrl() ?>">
                            <img class="hover-light-img" src="<?= $highPriorityProduct->getTitleImageUrl(210, 113) ?>" alt="<?= Html::encode($highPriorityProduct->getFullTitle()) ?>" />
                            <span class="m-premium"><?= Yii::t('app', 'On credit') ?></span>
                        </a>
                        <div class="h5"><a href="<?= $highPriorityProduct->getUrl() ?>"><?= $highPriorityProduct->getFullTitle() ?></a></div>
                        ...
                        <div class="b-featured__item-links">
                            <?php foreach($highPriorityProduct->getSpecifications(Specification::PRIORITY_HIGH) as $productSpec): ?>
                                <?php $spec = $productSpec->getSpecification()->one(); ?>
                                <a href="#" title="<?= $spec->i18n()->name ?>"><?= Html::encode($productSpec->getFormattedValue()) ?> <?= $spec->i18n()->unit ?></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
...
<section class="b-featured b-featured-latest">
    <div class="container">
        ...
        <div id="carousel-small-2" class="owl-carousel js-featured-vehicles-caruosel-2" data-items="4" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="4" data-items-desktop-small="4" data-items-tablet="3" data-items-tablet-small="2">
                ...
                <div>
                    <div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
                        <a href="<?= $latestAuto->getUrl() ?>">
                            <img class="hover-light-img" src="<?= $latestAuto->getTitleImageUrl(210, 113) ?>" alt="<?= Html::encode($latestAuto->getFullTitle()) ?>" />
                            <span class="m-premium"><?= Yii::t('app', 'On credit') ?></span>
                        </a>
                        <div class="h5"><a href="<?= $latestAuto->getUrl() ?>"><?= $latestAuto->getFullTitle() ?></a></div>
                        <div class="b-featured__item-price">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 col-xs-12">
                <a href="<?= $teaser->link ?>" class="b-asks__first wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    <div class="b-asks__first-circle">
                        <?php if ($teaser->hasTitleImage()): ?>
                        <img class="hover-light-img img-responsive" src="<?= $teaser->getTitleImageUrl(32, 32) ?>" alt="<?= $teaser->i18n()->header ?>" />
                        <?php endif; ?>
                    </div>
                ...
                <div class="b-welcome__services wow fadeInRight" data-wow-delay="0.3s" data-wow-offset="100">
                    <div class="row">
                        <?php for($teaserNum = 1; $teaserNum <=4; $teaserNum++): ?>
                            <a href="<?= $mainPageData["mainPageTeaser{$teaserNum}url"] ?>" class="col-xs-6 m-padding">
...
<section class="b-world">
    <div class="container">
        <h6 class="wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100"><?= Yii::t('app', 'Everything you need to know') ?></h6><br />
        <h2 class="s-title wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100"><a href="/news"><?= Yii::t('app', 'Auto news') ?></a></h2>
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                    ...
                    <a href="<?= $new->getUrl() ?>" class="btn m-btn"><?= Yii::t('app', 'Read more') ?><span class="fa fa-angle-right"></span></a>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
...
<section class="b-asks">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <p class="b-asks__call wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100"><?= Yii::t('app', 'QUESTIONS? CALL US') ?> : <span><a href="tel:<?= $appData['phone'] ?>" class="inheritColor"><?= $appData['phone'] ?></a></span></p>
            </div>
        </div>
    </div>
</section><!--b-asks-->
