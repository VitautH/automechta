...
<div class="b-map"  style="visibility: visible;">
    <?= $appData['map'] ?>
</div>
            ...
            <div class="col-xs-6">
                <div class="b-contacts__address">
                    ...
                    <div class="b-contacts__address-info">
                        <h2 class="s-titleDet"><?= Yii::t('app', 'Contact Information') ?></h2>
                            ...
                            <div class="b-contacts__address-info-main-item">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-xs-12">
                                        ...
                                        <em><a href="tel:<?= $appData['phone_credit_1'] ?>" class="inheritColor"><?= $appData['phone_credit_1'] ?></a></em><br>
                                        <em><a href="tel:<?= $appData['phone_credit_2'] ?>" class="inheritColor"><?= $appData['phone_credit_2'] ?></a></em><br>
                                        <em><a href="tel:<?= $appData['phone_credit_3'] ?>" class="inheritColor"><?= $appData['phone_credit_3'] ?></a></em>
