...
$this->registerJs("require(['controllers/catalog/new-searchForm.js']);", \yii\web\View::POS_HEAD);
...
<main>
    ...
    <h1>Продажа <? echo $typeName; ?>  <? echo $make_name; ?> в Беларуси в  кредит   <span class="count-ads"><?= Yii::t('app', 'Your search returned {n,plural,=0{# result} =1{# result} one{# results} other{# results}} ', ['n' => $_params_['count']]) ?>
</span></h1>
            </div>
        </div>
    </div>
