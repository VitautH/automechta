        ...
        <header class="b-detail__head s-lineDownLeft">
            ...
            <div class="flex-row">
                ...
                <div itemscope itemtype="http://schema.org/Product" class="b-detail__head-title">
                    <h1 itemprop="name"><?= $product->make ?>, <?= $model->year ?> г.в.</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php foreach ($product->similar as $similarProduct): ?>
                    <?php
                    $title =  $product->make.' '.$similarProduct->year.' г.в.';
                    ?>
                    <div class="col-md-3 b-featured__item  visible-md visible-lg visible-xl">
                        <a href="<?= Url::UrlShowProductBoat($similarProduct->id) ?>">
                        ...
                        <div class="inner_container">
                            <div class="h5">
                                <a href="<?= Url::UrlShowProductBoat($similarProduct->id) ?>"><?= $title ?></a>
                            </div>
                    ...
                    <noindex>
                        <div class="b-items__cars-one visible-xs visible-sm " data-key="<?= $product->id ?>">
                            <div class="visible-sm visible-xs  b-items__cars-one-info-header s-lineDownLeft">
                                <h2>
                                    <a href="<?= Url::UrlShowProductBoat($similarProduct->id) ?>"><?= Html::encode($similarProduct->full_title) ?></a>
