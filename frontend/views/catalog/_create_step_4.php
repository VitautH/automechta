...
<div class="row">
    ...
    <div class="col-md-6 col-xs-12">
        ...
        <div class="b-submit__main-element wow zoomInUp field-user-last_name required" data-wow-delay="0.5s">
            <label class="control-label" for="user-phone"><?= $model->getAttributeLabel('region') ?> <span class="text-danger">*</span></label>
        ...
        <div class="row">
            ...
            <div class="col-xs-5">
                <label class="control-label" for="user-phone"><?= $model->getAttributeLabel('phone_provider') ?> <span class="text-danger">*</span></label>
                <div class='s-relative'>
                    <?= Html::activeDropDownList(
                        $model,
                        'phone_provider',
        ...
        <div class="row">
            ...
            <div class="col-xs-5">
                <label class="control-label" for="user-phone"><?= $model->getAttributeLabel('phone_provider_2') ?></label>
                <div class='s-relative'>
                    <?= Html::activeDropDownList(
                        $model,
                        'phone_provider_2',
