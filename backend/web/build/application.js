define('components/jquery-private',[], function () {
    return $;
});
/**
 * Lists helper.
 ...
 */
define('i18n',['context', 'messages'], function (context, messages) {
    'use strict';
...
define('../assets/4c1f8857/normalize',[],function() {
...
define('../assets/4c1f8857/css',[],function() {
...
define('../assets/4c1f8857/css!../assets/e13874f1/js/libs/qtip/jquery.qtip.min',[],function(){});
/* qTip2 v2.2.1 | Plugins: tips viewport svg modal | Styles: core basic css3 | qtip2.com | Licensed MIT | Tue Aug 11 2015 04:30:48 */
...
define('polyfill',[], function () {
    ...
    if(!HTMLInputElement.prototype.setSelectionRange){
        HTMLInputElement.prototype.setSelectionRange = function(pos){
            if(!pos) pos = 0;
            if(this.createTextRange && pos){
...
define('../assets/4c1f8857/css!../assets/1e6a7a0b/jquery-ui.min',[],function(){});
...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		define('jquery_ui',[ "jquery" ], factory );
	} else {
