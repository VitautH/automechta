                        ...
                        <td id="task-<?php echo $task->id;?>-action" class="action">
                            ...
                            switch ($task->status) {
                                case Tasks::OPEN_STATUS:
                                    echo '<a href="#" data-status="'.Tasks::DURING_STATUS.'" data-url="/task/change-status?task=' . $task->id . '&status='.Tasks::DURING_STATUS.'" class="task-action open-task btn btn-app">
                <i class="fa fa-play"></i> Выполнять
              </a>';
                                    break;

                                case Tasks::DURING_STATUS:
                                    echo '<a href="#" data-status="'.Tasks::EXECUTED_STATUS.'" data-url="/task/change-status?task=' . $task->id . '&status='.Tasks::EXECUTED_STATUS.'" class="task-action during-task btn btn-app">
