...
$name = Yii::t('app', 'Product types');
$currentLang = Yii::$app->language;
$this->title = $name;
$this->registerJs("require(['controllers/producttype/index']);", \yii\web\View::POS_HEAD);
?>
<div class="mdl-grid page-header mdl-shadow--2dp">
    <div class="mdl-cell mdl-cell--12-col">
        ...
        <h2><?= $name ?></h2>
        <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--colored page-header__fab" href="<?= Url::to(['producttype/create']) ?>">
...
<div class="mdl-grid">
    <div class="mdl-cell mdl-cell--padding mdl-cell--12-col mdl-shadow--2dp">
        ...
        GridView::widget([
            ...
            'columns' => [
                [
                    'label' => $searchModel->i18n()->getAttributeLabel('name'),
                    'value' => function ($model, $key, $index, $column) {
                        return $model->i18n()->name;
                    },
                    ...
                    'filter' => MdlHtml::activeInput('text', $searchModel->i18n(), "[{$currentLang}]name", ['label' => $searchModel->i18n()->getAttributeLabel('name')])
                ],
                [
                    'label' => $searchModel->i18n()->getAttributeLabel('description'),
                    'value' => function ($model, $key, $index, $column) {
                        return $model->i18n()->description;
                    },
                    'headerOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'filterOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'contentOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'filter' => MdlHtml::activeInput('text', $searchModel->i18n(), "[{$currentLang}]description", ['label' => $searchModel->i18n()->getAttributeLabel('description')])
                ],
                [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::button(
                                ...
                                [
                                    ...
                                    'data-delete_url' => Url::to(['producttype/delete', 'id' => $model->id]),
                        ...
                        'update' => function ($url, $model, $key) {
                            return Html::a(
                                ...
                                Url::to(['producttype/update', 'id' => $model->id]),
                                [
