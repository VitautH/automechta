...
$name = Yii::t('app', 'Specifications');
$currentLang = Yii::$app->language;
$this->title = $name;
$this->registerJs("require(['controllers/specification/index']);", \yii\web\View::POS_HEAD);
?>
<div class="mdl-grid page-header mdl-shadow--2dp">
    <div class="mdl-cell mdl-cell--12-col">
        ...
        <h2><?= $name ?></h2>
        <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--colored page-header__fab" href="<?= Url::to(['specification/create']) ?>">
...
<div class="mdl-grid">
    <div class="mdl-cell mdl-cell--padding mdl-cell--12-col mdl-shadow--2dp">
        <?php \yii\widgets\Pjax::begin([
            'id' => 'specification_grid_wrapper',
            'linkSelector' => '#specification_grid_wrapper a:not(.button-col a)'
        ]); ?>
        <?=
        GridView::widget([
            'id' => 'specification_grid',
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'type',
                    'value' => function ($model, $key, $index, $column) {
                        return Specification::getTypes()[$model->type];
                    },
                    'headerOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'filterOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'contentOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'filter' => MdlHtml::activeDropDownList($searchModel, 'type', Specification::getTypes()),
                ],
                [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::button(
                                ...
                                [
                                    ...
                                    'data-delete_url' => Url::to(['specification/delete', 'id' => $model->id]),
                        ...
                        'update' => function ($url, $model, $key) {
                            return Html::a(
                                ...
                                Url::to(['specification/update', 'id' => $model->id]),
                                [
