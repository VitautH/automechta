...
$this->title = $name;
$this->registerJs("require(['controllers/slider/index']);", \yii\web\View::POS_HEAD);
?>
<div class="mdl-grid page-header mdl-shadow--2dp">
    <div class="mdl-cell mdl-cell--12-col">
        ...
        <h2><?= $name ?></h2>
        <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--colored page-header__fab" href="<?= Url::to(['slider/create']) ?>">
...
<div class="mdl-grid">
    <div class="mdl-cell mdl-cell--padding mdl-cell--12-col mdl-shadow--2dp">
        <?php \yii\widgets\Pjax::begin([
            'id' => 'slider_grid_wrapper',
            'linkSelector' => '#slider_grid_wrapper a:not(.button-col a)'
        ]); ?>
        <?=
        GridView::widget([
            'id' => 'slider_grid',
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::button(
                                ...
                                [
                                    ...
                                    'data-delete_url' => Url::to(['slider/delete', 'id' => $model->id]),
                        ...
                        'update' => function ($url, $model, $key) {
                            return Html::a(
                                ...
                                Url::to(['slider/update', 'id' => $model->id]),
                                [
