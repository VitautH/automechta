...
$this->title = $name;
$this->registerJs("require(['controllers/pages/index']);", \yii\web\View::POS_HEAD);
?>
<div class="mdl-grid page-header mdl-shadow--2dp">
    <div class="mdl-cell mdl-cell--12-col">
        ...
        <h2><?= $name ?></h2>
        <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--colored page-header__fab" href="<?= Url::to(['pages/create']) ?>">
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::button(
                                ...
                                [
                                    ...
                                    'data-delete_url' => Url::to(['pages/delete', 'id' => $model->id]),
                        ...
                        'update' => function ($url, $model, $key) {
                            return Html::a(
                                ...
                                Url::to(['pages/update', 'id' => $model->id]),
                                [
