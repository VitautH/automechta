...
$name = Yii::t('app', 'Permissions');
$this->title = $name;
$this->registerJs("require(['controllers/permissions/index']);", \yii\web\View::POS_HEAD);
...
<div class="mdl-grid page-header mdl-shadow--2dp">
    <div class="mdl-cell mdl-cell--12-col">
        ...
        <h2><?= $name ?></h2>
        <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--fab mdl-button--colored page-header__fab" href="<?= Url::to(['permissions/create']) ?>">
...
<div class="mdl-grid">
    <div class="mdl-cell mdl-cell--padding mdl-cell--12-col mdl-shadow--2dp">
        <?php \yii\widgets\Pjax::begin([
            'id' => 'permissions_grid_wrapper',
            'linkSelector' => '#permissions_grid_wrapper a:not(.button-col a)'
        ]); ?>
        <?=
        GridView::widget([
            'id' => 'permissions_grid',
            ...
            'columns' => [
                ...
                [
                    ...
                    'filterOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'contentOptions' => ['class' => 'mdl-data-table__cell--non-numeric'],
                    'filter' => MdlHtml::activeInput('text', $searchModel, 'description')
                ],
                [
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model, $key) {
                            return Html::button(
                                ...
                                [
                                    ...
                                    'data-delete_url' => Url::to(['permissions/delete', 'name' => $model->name]),
                        ...
                        'update' => function ($url, $model, $key) {
                            return Html::a(
                                ...
                                Url::to(['permissions/update', 'name' => $model->name]),
                                [
